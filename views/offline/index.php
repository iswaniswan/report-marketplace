...
/* @var $searchModel app\models\OfflineSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */


$this->title = 'Daftar Penjualan Offline';
            ...
            <div class="table-responsive">
                ...
                'columns' => [
                        ...
                        'value' => function($model) {
                            if ($model->tanggal_invoice != null) {
                                return date('d M Y', strtotime($model->tanggal_invoice));
                            }
                            return '-';
                        },
                        'headerOptions' => ['style' => 'text-align:left;'],
                        ...
                        //             [
                        // 'attribute' => 'alamat_customer',
                        // 'format' => 'raw',
                        // 'headerOptions' => ['style' => 'text-align:left;'],
                        // 'contentOptions' => ['style' => 'text-align:left'],
                        // ],
                        //             [
                        // 'attribute' => 'no_hp_customer',
                        // 'format' => 'raw',
                        // 'headerOptions' => ['style' => 'text-align:left;'],
                        // 'contentOptions' => ['style' => 'text-align:left'],
                        // ],
