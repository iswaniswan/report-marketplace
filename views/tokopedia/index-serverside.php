               ...
               <table class="table table-hover table-bordered" id="table-serverside">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 8%;">Nomor SKU</th>
                            <th style="width: 8%;">Tipe Produk</th>
...
$urlExportAll = Url::to(['tokopedia/export-all']);
...
$countAllStatus = count(Tokopedia::getListStatus());
...
$script = <<<JS
    ...
    $('#table-serverside').DataTable({
        ...
        columns: [
            ...
            { data: 'nomor_sku', orderable: false},
            { data: 'tipe_produk', orderable: false},
