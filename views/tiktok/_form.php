...
<?= $form->field($model, 'order_status')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'order_substatus')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'cancelation_return_type')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'normal_or_pre_order')->textarea(['rows' => 6]) ?>
...
<?= $form->field($model, 'variation')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'quantity')->textInput() ?>

<?= $form->field($model, 'sku_quantity_of_return')->textarea(['rows' => 6]) ?>
...
<?= $form->field($model, 'shipping_fee_seller_discount')->textarea(['rows' => 6]) ?>
...
<?= $form->field($model, 'created_time')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'paid_time')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'rts_time')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'shipped_time')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'delivered_time')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'cancelled_time')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'cancel_by')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'cancel_reason')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'fulfillment_type')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'warehouse_name')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'tracking_id')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'delivery_option')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'shipping_provider_name')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'buyer_message')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'buyer_username')->textarea(['rows' => 6]) ?>
...
<?= $form->field($model, 'regency_and_city')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'districts')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'villages')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'detail_address')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'additional_address_information')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'payment_method')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'weight_kg')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'product_category')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'package_id')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'seller_note')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'checked_status')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'checked_marked_by')->textarea(['rows' => 6]) ?>
