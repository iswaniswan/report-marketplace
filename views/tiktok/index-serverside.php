...
$style = <<<CSS
    ...
    #table-serverside tbody tr td:nth-child(13),
    #table-serverside tbody tr td:nth-child(14),
    #table-serverside tbody tr td:nth-child(15) {
        text-align: right
    }
...
$urlExportAll = Url::to(['tiktok/export-all']);
...
$countAllStatus = count(Tiktok::getListStatus());
$isAutoCheckedAll = (@$status == '' || empty(@$status) || @$status[0] == '') ? 1 : 0;

$headerPrint = 'Tiktok ' . date('d M Y', strtotime($date_start)) . ' - ' . date('d M Y', strtotime($date_end));
