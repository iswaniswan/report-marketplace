...
$this->title = 'Summary Tiktok';
$this->params['breadcrumbs'][] = $this->title;

echo \app\widgets\Breadcrumbs::widget([
    'links' => isset($this->params['breadcrumbs']) ? $this->params['breadcrumbs'] : [],
    'options' => [
        'title' => 'Summary Tiktok'
    ],
]);
...
<form action="<?= Url::to(['tiktok/index-summary']) ?>" method="GET">
    <div class="row mb-4">
...
<div class="row mb-4">
    <div class="col-xl-3 col-md-6">
        <div class="card-box tilebox-two">
            ...
            <h6 class="text-danger text-uppercase">Pesanan Canceled</h6>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card-box tilebox-two">
            <i class="icon-close float-right text-danger"></i>
            <h6 class="text-danger text-uppercase">Amount HJP Canceled</h6>
